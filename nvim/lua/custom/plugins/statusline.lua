...
options.gps = {
    ...
    right_sep = {
        str = options.separator_style.right,
        hl = { fg = options.colors.lightbg, bg = options.colors.white },
    },
}
...
options.empty_space_left_diagnostic = {
    provider = options.separator_style.right .. " ",
    hl = {
        fg = options.colors.statusline_bg,
        bg = options.colors.t_black,
    },
}
...
options.diagnostic = {
    error = {
        ...
        hl = { fg = options.colors.red, bg = options.colors.statusline_bg },
        icon = "  ",
    },
    ...
    warning = {
        ...
        hl = { fg = options.colors.yellow, bg = options.colors.statusline_bg },
        icon = "  ",
    },
    ...
    info = {
        ...
        hl = { fg = options.colors.green, bg = options.colors.statusline_bg },
        icon = "  ",
    },
}
...
options.mode_colors = {
    ...
    ["c"] = { "COMMAND", options.colors.yellow },
    ["cv"] = { "COMMAND", options.colors.yellow },
    ["ce"] = { "COMMAND", options.colors.yellow },
...
options.git_empty_space2 = {
    provider = " " .. options.separator_style.left,
    hl = {
        fg = options.colors.cyan,
        bg = options.colors.statusline_bg,
    },
}
...
add_table(options.left, options.gps)
add_table(options.left, options.dir_name)
add_table(options.left, options.empty_space_left)
...
add_table(options.left, options.empty_space_left_diagnostic)

add_table(options.middle, options.lsp_progress)

-- right
add_table(options.right, options.lsp_empty_space)
add_table(options.right, options.lsp_icon)
add_table(options.right, options.git_empty_space)
add_table(options.right, options.git_empty_space2)
